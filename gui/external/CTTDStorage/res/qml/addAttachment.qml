...
//    }
    ...
    Rectangle {
        ...
        ListView {
            ...
            highlight: Rectangle {
                Rectangle {
                    color: spaceListAddAttach.highlightFollowsCurrentItem ? "lightsteelblue" : "transparent"
                    border.color: "transparent"
                    x: 0
                    anchors.left: parent.left
                    anchors.leftMargin: 0
                ...
                color: spaceListAddAttach.highlightFollowsCurrentItem ? "#77000000" : "transparent"
            }
            clip: true
            focus: false
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: ((spaceListAddAttachRow.ListView.isCurrentItem && spaceListAddAttach.highlightFollowsCurrentItem) ||
                                spaceListAddAttachRow.hovered) ? "white" : "black"
                    }
        ...
        Rectangle {
            ...
            y: titleAreaSharingWin.height
            width: parent.width - addAttachLeftAreaLine.x
...
//                    }
        ...
        Button {
            ...
            Text {
                ...
                verticalAlignment: Text.AlignVCenter
                horizontalAlignment: Text.AlignHCenter
                color: (selectAttachment.enabled) ? (selectAttachment.hovered ? "white" : "black") : "#747589"
            }
        ...
        Button {
            ...
            Text {
                ...
                verticalAlignment: Text.AlignVCenter
                horizontalAlignment: Text.AlignHCenter
                color: addAttachCancel.hovered ? "white" : "black"
            }
