        ...
        Rectangle {
            ...
            Button {
                ...
                Text {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignHCenter
                    color: (mutiPages.currentIndex === 0 || myStorage.hovered) ? "#B4F5C9" : "lightsteelblue"
                }

                Rectangle {
                    color: mutiPages.currentIndex === 0 ? "#B4F5C9" : "transparent"
                    border.color: "transparent"
                    x: 0
                    ...
                    Item {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                implicitHeight: 4
                                radius: 2
                                color: (mutiPages.currentIndex === 1 || transmitList.hovered || transmitting.hovering) ? "#B4F5C9" : "lightsteelblue"
                                transform: [
                                    Translate {
            ...
            Button {
                ...
                Rectangle {
                    color: mutiPages.currentIndex === 1 ? "#B4F5C9" : "transparent"
                    border.color: "transparent"
                    x: 0
                    anchors.top: parent.bottom
                    anchors.bottomMargin: 2
            ...
            Button {
                ...
                Text {
                    ...
                    verticalAlignment: Text.AlignVCenter
                    horizontalAlignment: Text.AlignHCenter
                    color: (mutiPages.currentIndex === 2 || mySharing.hovered) ? "#B4F5C9" : "lightsteelblue"
                }

                Rectangle {
                    color: mutiPages.currentIndex === 2 ? "#B4F5C9" : "transparent"
                    border.color: "transparent"
                    x: 0
                    anchors.top: parent.bottom
                    anchors.bottomMargin: 2
...
//                    verticalAlignment: Text.AlignVCenter
//                    horizontalAlignment: Text.AlignHCenter
//                    color: (mutiPages.currentIndex === 3 || myMail.hovered) ? "#B4F5C9" : "lightsteelblue"
//                }
...
//            }
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Image {
                        id: imgLockState
                        source: main.lockState ? "qrc:/images/login/icon-user.png" : "qrc:/images/login/icon-user.png"
                        width: 20; height: 20
                    }
                }
                ...
                Row {
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            color: sendTransaction.pressed ? "#747589" : (sendTransaction.hovered ? "white" : "lightsteelblue")
                        }
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            color: lockUnlock.pressed ? "#747589" : (lockUnlock.hovered ? "white" : "lightsteelblue")
                        }
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            color: copyAccount.pressed ? "#747589" : (copyAccount.hovered ? "white" : "lightsteelblue")
                        }
                ...
                Connections {
                    target: main
                    onLockChanged: {
                        imgLockState.source = lock ? "qrc:/images/login/icon-lock.png" : "qrc:/images/login/icon-unlock.png"
                    }
                    onAccountChanged: {
        ...
        SwipeView {
            ...
            Page {
                ...
                Rectangle {
                    ...
                    border.color: "transparent"
                    x: 0
                    y: allSpace.height //titleMainWin.height + allSpace.height
                    width: mainLeftAreaLinePage1.x
                    height: 1
                }
                ...
                ListView {
                    ...
                    highlight: Rectangle {
                        Rectangle {
                            color: spaceList.highlightFollowsCurrentItem ? "lightsteelblue" : "transparent"
                            border.color: "transparent"
                            x: 0
                            anchors.left: parent.left
                            anchors.leftMargin: 0
                        ...
                        color: spaceList.highlightFollowsCurrentItem ? "#77000000" : "transparent"
                    }
                    clip: true
                    focus: false
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                color: ((spaceListRow.ListView.isCurrentItem && spaceList.highlightFollowsCurrentItem) ||
                                        spaceListRow.hovered) ? "white" : "black"
                            }
                ...
                Button {
                    ...
                    Text {
                        ...
                        verticalAlignment: Text.AlignVCenter
                        horizontalAlignment: Text.AlignHCenter
                        color: (mainWindow.spaceCategory === -1 || sharingSpace.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.spaceCategory === -1 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.spaceCategory === -1 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
                ...
                Button {
                    ...
                    Text {
                        ...
                        color: createSpace.enabled ? (createSpace.hovered ? "white" : "black") : "#747589"
                    }
                ...
                Button {
                    ...
                    width: 60
                    height: 10
                    enabled: (main.atService && (main.getSpaceLabelByIndex(spaceList.currentIndex) !== "") &&
                              (main.getSpaceLabelByIndex(spaceList.currentIndex) !== guiString.sysMsgs(GUIString.SharingSpaceLabel))&&
                              mainWindow.spaceCategory !== -1)
                    ...
                    Text {
                        ...
                        color: expandSpace.enabled ? (expandSpace.hovered ? "white" : "black") : "#747589"
                    }

                    background: Rectangle { color: "transparent"; border.color: "transparent" }

                    //onClicked: console.log(spaceList.currentIndex, main.getSpaceLabelByIndex(spaceList.currentIndex), mainWindow.spaceCategory)
                }
                ...
                Rectangle {
                    ...
                    x: mainLeftAreaLinePage1.x
                    y: allSpace.height //titleMainWin.height + allSpace.height
                    width: parent.width - mainLeftAreaLinePage1.x
                ...
                Button {
                    ...
                    height: 30
                    enabled: main.atService && (fileList.currentIndex >= 0)

                    background: Rectangle {
                        implicitHeight: downloadBtn.height
                        implicitWidth:  downloadBtn.width
                        color: "transparent"
                        border.color: downloadBtn.pressed ? "#747589" : (downloadBtn.hovered ? "lightsteelblue" : "transparent")
                        radius: 2
                        ...
                        Text {
                            ...
                            text: qsTr("下载")
                            font.pointSize: 11
                            color: downloadBtn.enabled ? (downloadBtn.hovered ? "lightsteelblue" : "black") : "#747589"
                        }
                    }
                ...
                Button {
                    ...
                    enabled: expandSpace.enabled

                    background: Rectangle {
                        implicitHeight: uploadBtn.height
                        implicitWidth:  uploadBtn.width
                        color: "transparent"
                        border.color: uploadBtn.pressed ? "#747589" : (uploadBtn.hovered ? "lightsteelblue" : "transparent")
                        radius: 2
                        ...
                        Text {
                            ...
                            text: qsTr("上传")
                            font.pointSize: 11
                            color: uploadBtn.enabled ? (uploadBtn.hovered ? "lightsteelblue" : "black") : "#747589"
                        }
                    }
                ...
                Button {
                    ...
                    background: Rectangle {
                        ...
                        color: "transparent"
                        border.color: shareFileBtn.pressed ? "#747589" : (shareFileBtn.hovered ? "lightsteelblue" : "transparent")
                        radius: 2
                        ...
                        Text {
                            ...
                            text: qsTr("分享")
                            font.pointSize: 11
                            color: shareFileBtn.enabled ? (shareFileBtn.hovered ? "lightsteelblue" : "black") : "#747589"
                        }
                    }
                ...
                Button {
                    ...
                    background: Rectangle {
                        ...
                        color: "transparent"
                        border.color: refreshBtn.pressed ? "#747589" : (refreshBtn.hovered ? "lightsteelblue" : "transparent")
                        radius: 2
                        ...
                        Text {
                            ...
                            text: qsTr("刷新")
                            font.pointSize: 11
                            color: refreshBtn.enabled ? (refreshBtn.hovered ? "lightsteelblue" : "black") : "#747589"
                        }
                    }
                    ...
                    ListView {
                        ...
                        delegate: Row {
                            ...
                            Rectangle {
                                ...
                                color: fileListRow.hovered ? "#55B0C4DE" : "transparent"
                                Text {
                                    ...
                                    color: (fileListRow.ListView.isCurrentItem || fileListRow.hovered) ? "black" : "lightsteelblue"
                                }
            ...
            Page {
                ...
                Button {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignLeft
                        leftPadding: 20 + 25
                        color: (mainWindow.transmitCategory === 0 || downloadingLabel.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.transmitCategory === 0 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.transmitCategory === 0 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
                ...
                Button {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignLeft
                        leftPadding: 20 + 25
                        color: (mainWindow.transmitCategory === 1 || uploadingLabel.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.transmitCategory === 1 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.transmitCategory === 1 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
                ...
                Button {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignLeft
                        leftPadding: 20 + 25
                        color: (mainWindow.transmitCategory === 2 || completedLabel.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.transmitCategory === 2 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.transmitCategory === 2 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
            ...
            Page {
                ...
                Button {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignLeft
                        leftPadding: 20 + 25
                        color: (mainWindow.sharingCategory === 0 || getSharing.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.sharingCategory === 0 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.sharingCategory === 0 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
                ...
                Button {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignLeft
                        leftPadding: 20 + 25
                        color: (mainWindow.sharingCategory === 1 || sendingMail.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.sharingCategory === 1 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.sharingCategory === 1 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
                ...
                Button {
                    ...
                    Text {
                        ...
                        horizontalAlignment: Text.AlignLeft
                        leftPadding: 20 + 25
                        color: (mainWindow.sharingCategory === 2 || receivingMail.hovered) ? "white" : "black"
                    }

                    Rectangle {
                        color: mainWindow.sharingCategory === 2 ? "lightsteelblue" : "transparent"
                        border.color: "transparent"
                        x: 0
                        anchors.left: parent.left
                        anchors.leftMargin: 0
                    ...
                    background: Rectangle {
                        color: mainWindow.sharingCategory === 2 ? "#77000000" : "transparent"
                        border.color: "transparent"
                    }
                ...
                Rectangle {
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            verticalAlignment: Text.AlignVCenter
                            horizontalAlignment: Text.AlignHCenter
                            color: payforSharingFile.enabled ? (payforSharingFile.hovered ? "white" : "black") : "#747589"
                        }
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            verticalAlignment: Text.AlignVCenter
                            horizontalAlignment: Text.AlignHCenter
                            color: clearSharingCode.hovered ? "white" : "black"
                        }
                        ...
                        onClicked: sharingCodeInput.text = ""
                    }
                ...
                Rectangle {
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            ...
                            color: "transparent"
                            border.color: refreshMailsBtn.pressed ? "#747589" : (refreshMailsBtn.hovered ? "lightsteelblue" : "transparent")
                            radius: 2
                            ...
                            Text {
                                ...
                                text: qsTr("刷新")
                                font.pointSize: 11
                                color: refreshMailsBtn.enabled ? (refreshMailsBtn.hovered ? "lightsteelblue" : "black") : "darkgrey"
                            }
                        }
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            ...
                            color: "transparent"
                            border.color: openMailBtn.pressed ? "#747589" : (openMailBtn.hovered ? "lightsteelblue" : "transparent")
                            radius: 2
                            ...
                            Text {
                                ...
                                text: qsTr("查看")
                                font.pointSize: 11
                                color: openMailBtn.enabled ? (openMailBtn.hovered ? "lightsteelblue" : "black") : "darkgrey"
                            }
                        }
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            ...
                            color: "transparent"
                            border.color: returnToListBtn.pressed ? "#747589" : (returnToListBtn.hovered ? "lightsteelblue" : "transparent")
                            radius: 2
                            ...
                            Text {
                                ...
                                text: qsTr("返回")
                                font.pointSize: 11
                                color: returnToListBtn.enabled ? (returnToListBtn.hovered ? "lightsteelblue" : "black") : "darkgrey"
                            }
                        }

                        onClicked: receivingMailView.opened = false
                    }
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            ...
                            color: "transparent"
                            border.color: getAttachmentBtn.pressed ? "#747589" : (getAttachmentBtn.hovered ? "lightsteelblue" : "transparent")
                            radius: 2
                            ...
                            Text {
                                ...
                                text: qsTr("附件")
                                font.pointSize: 11
                                color: getAttachmentBtn.enabled ? (getAttachmentBtn.hovered ? "lightsteelblue" : "black") : "darkgrey"
                            }
                        }
                        ...
                        ListView {
                            ...
                            delegate: Row {
                                ...
                                Rectangle {
                                    ...
                                    color: mailListRow.hovered ? "#55B0C4DE" : "transparent"
                                    Text {
                                        ...
                                        elide: Text.ElideRight
                                        font.pointSize: 11
                                        color: (mailListRow.ListView.isCurrentItem || mailListRow.hovered) ? "black" : "lightsteelblue"
                                    }
                ...
                Rectangle {
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            verticalAlignment: Text.AlignVCenter
                            horizontalAlignment: Text.AlignHCenter
                            color: (addMailAttachment.enabled) ? (addMailAttachment.hovered ? "white" : "black") : "#747589"
                        }
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            verticalAlignment: Text.AlignVCenter
                            horizontalAlignment: Text.AlignHCenter
                            color: (clearMailAttachment.enabled) ? (clearMailAttachment.hovered ? "white" : "black") : "#747589"
                        }
                    ...
                    Button {
                        ...
                        Text {
                            ...
                            verticalAlignment: Text.AlignVCenter
                            horizontalAlignment: Text.AlignHCenter
                            color: (sendMail.enabled) ? (sendMail.hovered ? "white" : "black") : "#747589"
                        }
