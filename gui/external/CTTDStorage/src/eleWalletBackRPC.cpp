...
QString EleWalletBackRPCCli::sendOperationCmdThread(int cmd, QList<QString> opParams)
{
    ...
    std::thread t(bind(&EleWalletBackRPCCli::sendOperationCmd, this, cmd, opParams, timeOutLimit, true));
    t.detach();
    return "runing in thread";
}

QString EleWalletBackRPCCli::sendOperationCmd(int cmd, QList<QString> opParams, int timeOutLimit, bool isthread)
{
